    ...
    <div class="main-content">
        ...
        <div class="dashboard-grid">
            <div class="dashboard-card">
                ...
                <h3 style="font-size: 2.5rem; color: var(--accent-color); margin: 1rem 0;">2,500</h3>
                <p style="color: #64748b;">Poin tersedia untuk ditukar</p>
                <div style="margin-top: 1rem;">
                    <div style="width: 75%; height: 6px; background: #e2e8f0; border-radius: 10px;">
                        <div style="width: 60%; height: 100%; background: linear-gradient(to right, var(--gradient-start), var(--gradient-end)); border-radius: 10px;"></div>
                    </div>
                    <p style="color: #64748b; font-size: 0.9rem; margin-top: 0.5rem;">1,500 poin lagi menuju Silver Member</p>
                </div>
            </div>
